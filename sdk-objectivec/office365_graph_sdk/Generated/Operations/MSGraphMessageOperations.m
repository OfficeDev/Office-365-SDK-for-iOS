...
- (NSURLSessionTask *)copyWithDestinationId:(NSString *) destinationId callback:(void (^)(MSGraphMessage *message, MSODataException *exception))callback {
...
- (NSURLSessionTask *)moveWithDestinationId:(NSString *) destinationId callback:(void (^)(MSGraphMessage *message, MSODataException *exception))callback {
...
- (NSURLSessionTask *)createReplyWithCallback:(void (^)(MSGraphMessage *message, MSODataException *exception))callback {
...
- (NSURLSessionTask *)createReplyAllWithCallback:(void (^)(MSGraphMessage *message, MSODataException *exception))callback {
...
- (NSURLSessionTask *)createForwardWithCallback:(void (^)(MSGraphMessage *message, MSODataException *exception))callback {
...
- (NSURLSessionTask *)forwardWithComment:(NSString *) comment toRecipients:(MSGraphRecipient *) toRecipients callback:(void (^)(int returnValue, MSODataException *exception))callback {
