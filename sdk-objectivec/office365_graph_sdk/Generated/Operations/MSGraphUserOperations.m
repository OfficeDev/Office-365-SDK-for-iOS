...
- (void)assignLicenseWithAddLicenses:(NSArray<MSGraphAssignedLicense> *)addLicenses removeLicenses:(NSArray *)removeLicenses callback:(void (^)(MSGraphUser *user, MSOrcError *error))callback {
