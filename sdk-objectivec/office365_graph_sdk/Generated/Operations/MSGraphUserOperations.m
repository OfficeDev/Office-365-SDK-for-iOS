...
- (NSURLSessionTask *)assignLicenseWithAddLicenses:(MSGraphAssignedLicense *) addLicenses removeLicenses:(NSString *) removeLicenses callback:(void (^)(MSGraphUser *user, MSODataException *exception))callback {
...
- (NSURLSessionTask *)sendMailWithMessage:(MSGraphMessage *) message saveToSentItems:(BOOL ) saveToSentItems callback:(void (^)(int returnValue, MSODataException *exception))callback {
