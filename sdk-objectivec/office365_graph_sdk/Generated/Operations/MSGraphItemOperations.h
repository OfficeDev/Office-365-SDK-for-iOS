...
@interface MSGraphItemOperations : MSODataOperations

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSODataExecutable>)parent;

- (NSURLSessionTask *)copyWithDestFolderId:(NSString *) destFolderId destFolderPath:(NSString *) destFolderPath newName:(NSString *) newName callback:(void (^)(MSGraphItem *item, MSODataException *exception))callback;
