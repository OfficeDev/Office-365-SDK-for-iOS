...
- (NSURLSessionTask *)updateDirectoryRoleTemplate:(id)entity callback:(void (^)(MSGraphServiceDirectoryRoleTemplate *directoryRoleTemplate, MSODataException *exception))callback {
