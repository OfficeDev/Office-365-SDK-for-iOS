...
@property  (nonatomic, getter=type, setter=setType:) MSGraphServiceRecurrencePatternType Type;
...
@property (retain, nonatomic, readwrite, getter=daysOfWeek, setter=setDaysOfWeek:) NSMutableArray<MSGraphServiceDayOfWeek> *DaysOfWeek;
@property  (nonatomic, getter=firstDayOfWeek, setter=setFirstDayOfWeek:) MSGraphServiceDayOfWeek FirstDayOfWeek;
- (void)setFirstDayOfWeekString:(NSString *)value;
@property  (nonatomic, getter=index, setter=setIndex:) MSGraphServiceWeekIndex Index;
