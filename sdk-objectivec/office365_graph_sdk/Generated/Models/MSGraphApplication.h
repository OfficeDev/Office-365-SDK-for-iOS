...
@property (retain, nonatomic, readwrite, getter=requiredResourceAccess, setter=setRequiredResourceAccess:) NSMutableArray<MSGraphRequiredResourceAccess> *requiredResourceAccess;
@property (retain, nonatomic, readwrite, getter=samlMetadataUrl, setter=setSamlMetadataUrl:) NSString *samlMetadataUrl;
@property (retain, nonatomic, readwrite, getter=extensionProperties, setter=setExtensionProperties:) NSMutableArray<MSGraphExtensionProperty> *extensionProperties;
