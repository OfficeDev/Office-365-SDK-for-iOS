...
/**
* The implementation file for type MSODirectoryDeviceConfigurationFetcher.
*/


@implementation MSODirectoryDeviceConfigurationFetcher

-(MSODirectoryDeviceConfigurationOperations*) getOperations{
	return [[MSODirectoryDeviceConfigurationOperations alloc] initOperationWithUrl:self.UrlComponent parent:self.Parent];
}
