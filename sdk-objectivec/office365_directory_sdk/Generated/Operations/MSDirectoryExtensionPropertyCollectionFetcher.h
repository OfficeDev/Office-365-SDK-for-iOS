...
-(NSURLSessionDataTask*)addEntity:(MSDirectoryExtensionProperty* )entity withCallback:(void (^)(MSDirectoryExtensionProperty *extensionProperty, NSError *e))callback;
