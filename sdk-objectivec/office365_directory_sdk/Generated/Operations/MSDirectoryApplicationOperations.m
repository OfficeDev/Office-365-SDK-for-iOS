...
- (NSURLSessionTask *)restoreWithIdentifierUris:(NSString *) identifierUris callback:(void (^)(MSDirectoryApplication *application, MSODataException *exception))callback {
