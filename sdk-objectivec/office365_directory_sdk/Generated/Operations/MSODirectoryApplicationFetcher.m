...
/**
* The implementation file for type MSODirectoryApplicationFetcher.
*/


@implementation MSODirectoryApplicationFetcher

-(MSODirectoryApplicationOperations*) getOperations{
	return [[MSODirectoryApplicationOperations alloc] initOperationWithUrl:self.UrlComponent parent:self.Parent];
}
...
-(MSODirectoryExtensionPropertyCollectionFetcher*) getextensionProperties{
    return [[MSODirectoryExtensionPropertyCollectionFetcher alloc] initWithUrl:@"extensionProperties" parent:self andEntityClass:[MSODirectoryExtensionProperty class]];
}
