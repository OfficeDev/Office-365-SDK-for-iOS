...
/**
* The implementation file for type MSODirectoryAppRoleAssignmentFetcher.
*/


@implementation MSODirectoryAppRoleAssignmentFetcher

-(MSODirectoryAppRoleAssignmentOperations*) getOperations{
	return [[MSODirectoryAppRoleAssignmentOperations alloc] initOperationWithUrl:self.UrlComponent parent:self.Parent];
}
