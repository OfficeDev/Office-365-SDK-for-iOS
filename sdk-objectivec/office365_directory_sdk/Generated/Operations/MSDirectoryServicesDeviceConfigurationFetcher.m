...
- (NSURLSessionTask *)updateDeviceConfiguration:(id)entity callback:(void (^)(MSDirectoryServicesDeviceConfiguration *deviceConfiguration, MSODataException *exception))callback {
