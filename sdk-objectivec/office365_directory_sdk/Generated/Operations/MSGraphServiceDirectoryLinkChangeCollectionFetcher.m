...
-(MSGraphServiceDirectoryLinkChangeFetcher*)getById:(NSString *)Id{
	[super getById:Id];
    return [[MSGraphServiceDirectoryLinkChangeFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,Id] parent : self andEntityClass :[MSGraphServiceDirectoryLinkChange class]];
}
@end