...
@implementation MSGraphServiceCalendarViewFetcher

-(MSGraphServiceCalendarViewOperations*) getOperations{
	return [[MSGraphServiceCalendarViewOperations alloc] initOperationWithUrl:self.UrlComponent parent:self.Parent];
}
