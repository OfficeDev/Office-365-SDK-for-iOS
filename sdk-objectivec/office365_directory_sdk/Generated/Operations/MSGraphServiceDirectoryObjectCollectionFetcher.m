...
-(MSGraphServiceDirectoryObjectFetcher*)getById:(NSString *)Id{
	[super getById:Id];
    return [[MSGraphServiceDirectoryObjectFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,Id] parent : self andEntityClass :[MSGraphServiceDirectoryObject class]];
}
@end