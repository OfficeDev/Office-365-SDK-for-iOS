...
/**
* The implementation file for type MSODirectoryExtensionPropertyFetcher.
*/


@implementation MSODirectoryExtensionPropertyFetcher

-(MSODirectoryExtensionPropertyOperations*) getOperations{
	return [[MSODirectoryExtensionPropertyOperations alloc] initOperationWithUrl:self.UrlComponent parent:self.Parent];
}
