...
/**
* The implementation file for type MSODirectoryOAuth2PermissionGrantFetcher.
*/


@implementation MSODirectoryOAuth2PermissionGrantFetcher

-(MSODirectoryOAuth2PermissionGrantOperations*) getOperations{
	return [[MSODirectoryOAuth2PermissionGrantOperations alloc] initOperationWithUrl:self.UrlComponent parent:self.Parent];
}
