...
-(MSGraphServiceExtensionPropertyFetcher*)getById:(NSString *)Id{
	[super getById:Id];
    return [[MSGraphServiceExtensionPropertyFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,Id] parent : self andEntityClass :[MSGraphServiceExtensionProperty class]];
}
@end