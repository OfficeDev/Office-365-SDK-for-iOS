...
/**
* The implementation file for type MSODirectoryDirectoryLinkChangeFetcher.
*/


@implementation MSODirectoryDirectoryLinkChangeFetcher

-(MSODirectoryDirectoryLinkChangeOperations*) getOperations{
	return [[MSODirectoryDirectoryLinkChangeOperations alloc] initOperationWithUrl:self.UrlComponent parent:self.Parent];
}
