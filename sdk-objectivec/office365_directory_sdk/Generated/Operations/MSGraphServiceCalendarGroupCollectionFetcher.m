...
-(MSGraphServiceCalendarGroupFetcher*)getById:(NSString *)Id{
	[super getById:Id];
    return [[MSGraphServiceCalendarGroupFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,Id] parent : self andEntityClass :[MSGraphServiceCalendarGroup class]];
}
@end