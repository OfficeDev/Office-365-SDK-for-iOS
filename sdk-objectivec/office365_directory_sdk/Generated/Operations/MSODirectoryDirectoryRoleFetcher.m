...
/**
* The implementation file for type MSODirectoryDirectoryRoleFetcher.
*/


@implementation MSODirectoryDirectoryRoleFetcher

-(MSODirectoryDirectoryRoleOperations*) getOperations{
	return [[MSODirectoryDirectoryRoleOperations alloc] initOperationWithUrl:self.UrlComponent parent:self.Parent];
}
