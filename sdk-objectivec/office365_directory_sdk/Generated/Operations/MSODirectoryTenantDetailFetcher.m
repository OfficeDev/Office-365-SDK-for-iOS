...
/**
* The implementation file for type MSODirectoryTenantDetailFetcher.
*/


@implementation MSODirectoryTenantDetailFetcher

-(MSODirectoryTenantDetailOperations*) getOperations{
	return [[MSODirectoryTenantDetailOperations alloc] initOperationWithUrl:self.UrlComponent parent:self.Parent];
}
