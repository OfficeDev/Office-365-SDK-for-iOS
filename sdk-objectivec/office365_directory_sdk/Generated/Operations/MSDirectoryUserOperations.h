...
- (NSURLSessionTask *)assignLicenseWithAddLicenses:(MSDirectoryAssignedLicense *) addLicenses removeLicenses:(NSString *) removeLicenses callback:(void (^)(MSDirectoryUser *user, MSODataException *exception))callback;
