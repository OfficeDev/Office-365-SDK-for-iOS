...
/**
* The implementation file for type MSODirectorySubscribedSkuFetcher.
*/


@implementation MSODirectorySubscribedSkuFetcher

-(MSODirectorySubscribedSkuOperations*) getOperations{
	return [[MSODirectorySubscribedSkuOperations alloc] initOperationWithUrl:self.UrlComponent parent:self.Parent];
}
