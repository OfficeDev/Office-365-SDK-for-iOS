...
-(MSGraphServiceMessageOperations*) getOperations{
	return [[MSGraphServiceMessageOperations alloc] initOperationWithUrl:self.UrlComponent parent:self.Parent];
}
...
-(id)initWithUrl:(NSString*)urlComponent :(id<MSODataExecutable>)parent{
    ...
    return [super initWithUrl:urlComponent parent:parent andEntityClass : [MSGraphServiceMessage class]];
}
