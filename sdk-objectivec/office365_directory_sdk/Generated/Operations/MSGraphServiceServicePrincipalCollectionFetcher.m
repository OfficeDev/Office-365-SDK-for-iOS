...
-(MSGraphServiceServicePrincipalFetcher*)getById:(NSString *)Id{
	[super getById:Id];
    return [[MSGraphServiceServicePrincipalFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,Id] parent : self andEntityClass :[MSGraphServiceServicePrincipal class]];
}
@end