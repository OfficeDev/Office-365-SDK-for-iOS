...
/**
* The implementation file for type MSFilesItemCollectionOperations.
*/

@implementation MSFilesItemCollectionOperations
-(NSURLSessionDataTask*)getByPath : (NSString *) path : (void (^)(MSOItem *item, NSError *error))callback{
	...
	NSURLSessionDataTask* task = [super oDataExecute:url :payload :POST :^(id<MSFilesResponse> r, NSError *error) {
