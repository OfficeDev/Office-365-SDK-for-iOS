...
@property (retain, nonatomic, readwrite, getter=prepaidUnits, setter=setPrepaidUnits:) MSDirectoryLicenseUnitsDetail *prepaidUnits;
@property (retain, nonatomic, readwrite, getter=servicePlans, setter=setServicePlans:) NSMutableArray<MSDirectoryServicePlanInfo> *servicePlans;
