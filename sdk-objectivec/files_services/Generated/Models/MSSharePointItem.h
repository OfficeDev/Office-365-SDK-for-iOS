...
@property (retain, nonatomic, readwrite, getter=createdBy, setter=setCreatedBy:) MSSharePointIdentitySet *createdBy;
...
@property (retain, nonatomic, readwrite, getter=lastModifiedBy, setter=setLastModifiedBy:) MSSharePointIdentitySet *lastModifiedBy;
@property (retain, nonatomic, readwrite, getter=name, setter=setName:) NSString *name;
@property (retain, nonatomic, readwrite, getter=parentReference, setter=setParentReference:) MSSharePointItemReference *parentReference;
