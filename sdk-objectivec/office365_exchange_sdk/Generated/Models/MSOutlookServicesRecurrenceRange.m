...
@implementation MSOutlookServicesRecurrenceRange	
...
- (void)setTypeString:(NSString *)value {
	...
	if ([value isEqualToString:@"EndDate"]) {
		...
		self.Type = MSOutlookServices_RecurrenceRangeType_EndDate;
	}

	if ([value isEqualToString:@"NoEnd"]) {

		self.Type = MSOutlookServices_RecurrenceRangeType_NoEnd;
	}

	if ([value isEqualToString:@"Numbered"]) {

		self.Type = MSOutlookServices_RecurrenceRangeType_Numbered;
	}
}
