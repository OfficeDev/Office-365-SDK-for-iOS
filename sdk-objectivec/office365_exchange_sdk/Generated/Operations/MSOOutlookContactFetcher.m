...
/**
* The implementation file for type MSOOutlookContactFetcher.
*/


@implementation MSOOutlookContactFetcher

-(MSOOutlookContactOperations*) getOperations{
	return [[MSOOutlookContactOperations alloc] initOperationWithUrl:self.UrlComponent parent:self.Parent];
}
