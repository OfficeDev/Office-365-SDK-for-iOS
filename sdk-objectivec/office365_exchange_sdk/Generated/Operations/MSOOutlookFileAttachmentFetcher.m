...
/**
* The implementation file for type MSOOutlookFileAttachmentFetcher.
*/


@implementation MSOOutlookFileAttachmentFetcher

-(MSOOutlookFileAttachmentOperations*) getOperations{
	return [[MSOOutlookFileAttachmentOperations alloc] initOperationWithUrl:self.UrlComponent parent:self.Parent];
}
