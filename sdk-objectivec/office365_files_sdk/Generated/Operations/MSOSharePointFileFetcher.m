...
/**
* The implementation file for type MSOSharePointFileFetcher.
*/


@implementation MSOSharePointFileFetcher

-(MSOSharePointFileOperations*) getOperations{
	return [[MSOSharePointFileOperations alloc] initOperationWithUrl:self.UrlComponent parent:self.Parent];
}
