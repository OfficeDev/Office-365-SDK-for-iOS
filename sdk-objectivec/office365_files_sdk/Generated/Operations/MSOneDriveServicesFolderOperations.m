...
/**
* The implementation file for type MSOneDriveServicesFolderOperations.
*/

@implementation MSOneDriveServicesFolderOperations
...
- (NSURLSessionTask *)copyWithDestFolderId:(NSString *)destFolderId destFolderPath:(NSString *)destFolderPath newName:(NSString *)newName callback:(void (^)(MSOneDriveServicesFolder *folder, MSODataException *exception))callback {
	...
	NSURLSessionTask *task = [self copyRawWithDestFolderId:destFolderIdString destFolderPath:destFolderPathString newName:newNameString callback:^(NSString *returnValue, MSODataException *exception) {
	   ...
	   if (exception == nil) {
			...
			MSOneDriveServicesFolder * result = (MSOneDriveServicesFolder *)[super.resolver.jsonSerializer deserialize:[returnValue dataUsingEncoding:NSUTF8StringEncoding] asClass:[MSOneDriveServicesFolder class]];
