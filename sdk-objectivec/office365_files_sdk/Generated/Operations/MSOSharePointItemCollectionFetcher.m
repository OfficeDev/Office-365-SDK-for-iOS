...
/**
* The implementation file for type MSOSharePointItemCollectionFetcher.
*/

@implementation MSOSharePointItemCollectionFetcher
...
-(MSOSharePointItemFetcher*)getById:(NSString *)Id{
	[super getById:Id];
    return [[MSOSharePointItemFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,Id] parent : self andEntityClass :[MSOSharePointItem class]];
}
@end