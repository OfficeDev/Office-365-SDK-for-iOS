...
/**
* The implementation file for type MSOSharePointFolderOperations.
*/

@implementation MSOSharePointFolderOperations

-(id)initWithUrl:(NSString *)urlComponent parent:(id<MSODataReadable>)parent{
    return [super initOperationWithUrl:urlComponent parent:parent];
}

-(NSURLSessionDataTask*)copy : (NSString *) destFolderId : (NSString *) destFolderPath : (NSString *) newName : (void (^)(MSOSharePointFolder *folder, NSError *error))callback{
	...
	NSURLSessionDataTask* task = [super oDataExecuteForPath:url withContent : payload andMethod:POST andCallback:^(id<MSODataResponse> r, NSError *error) {
       ...
       if(error == nil){
			MSOSharePointFolder * result = (MSOSharePointFolder *)[[[self getResolver]getJsonSerializer] deserialize:[r getData] : [MSOSharePointFolder class]];
