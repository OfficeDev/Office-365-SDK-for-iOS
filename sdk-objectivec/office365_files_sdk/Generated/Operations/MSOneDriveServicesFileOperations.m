...
/**
* The implementation file for type MSOneDriveServicesFileOperations.
*/

@implementation MSOneDriveServicesFileOperations
...
- (NSURLSessionTask *)copyWithDestFolderId:(NSString *)destFolderId destFolderPath:(NSString *)destFolderPath newName:(NSString *)newName callback:(void (^)(MSOneDriveServicesFile *file, MSODataException *exception))callback {
	...
	NSURLSessionTask *task = [self copyRawWithDestFolderId:destFolderIdString destFolderPath:destFolderPathString newName:newNameString callback:^(NSString *returnValue, MSODataException *exception) {
	   ...
	   if (exception == nil) {
			...
			MSOneDriveServicesFile * result = (MSOneDriveServicesFile *)[super.resolver.jsonSerializer deserialize:[returnValue dataUsingEncoding:NSUTF8StringEncoding] asClass:[MSOneDriveServicesFile class]];
