...
@class MSOneDriveServicesIdentitySet;
@class MSOneDriveServicesItemReference;
...
@interface MSOneDriveServicesItem : NSObject

@property (retain, nonatomic, readonly) NSString *odataType;
@property (retain, nonatomic, readwrite, getter=createdBy, setter=setCreatedBy:) MSOneDriveServicesIdentitySet *createdBy;
...
@property (retain, nonatomic, readwrite, getter=lastModifiedBy, setter=setLastModifiedBy:) MSOneDriveServicesIdentitySet *lastModifiedBy;
@property (retain, nonatomic, readwrite, getter=name, setter=setName:) NSString *name;
@property (retain, nonatomic, readwrite, getter=parentReference, setter=setParentReference:) MSOneDriveServicesItemReference *parentReference;
