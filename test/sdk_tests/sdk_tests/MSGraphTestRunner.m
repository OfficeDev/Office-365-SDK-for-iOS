...
-(void)TestGetUserFilesById:(void (^) (Test*))result{
    ...
    return [[self.Client.users getById:self.TestMail].drive.root.children readWithCallback:^(NSArray *items, MSOrcError *error) {
        ...
        [[[self.Client.users getById:self.TestMail].drive.items getById:itemId] readWithCallback:^(MSGraphDriveItem *item, MSOrcError *error) {
...
-(void)TestCreateFileWithContent:(void (^) (Test*))result {
    MSGraphDriveItem *itemToAdd = [self getFileItem];
    ...
    //Create file
    return [[self.Client.users getById:self.TestMail].drive.root.children add:itemToAdd callback:^(MSGraphDriveItem *addedItem, MSOrcError *error) {
