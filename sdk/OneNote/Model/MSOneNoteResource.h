...
#ifndef MSONENOTERESOURCE_H
#define MSONENOTERESOURCE_H
...
/** Interface MSOneNoteResource
 *
 */
@interface MSOneNoteResource : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>
