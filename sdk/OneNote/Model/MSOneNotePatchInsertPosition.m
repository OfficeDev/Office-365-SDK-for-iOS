...
@implementation MSOneNotePatchInsertPositionSerializer
...
+(NSString *) toString: (MSOneNotePatchInsertPosition) value {
    ...
    {
        stringMappings=[[NSDictionary alloc] initWithObjectsAndKeys:
         @"After", [NSNumber numberWithInt:MSOneNotePatchInsertPositionAfter], @"Before", [NSNumber numberWithInt:MSOneNotePatchInsertPositionBefore],
            nil        
        ];
    }
