...
/** Implementation for MSOneNoteComplexUser
 *
 */
@implementation MSOneNoteComplexUser
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_odataType = @"#Microsoft.OneNote.Api.ComplexUser";
 ...
 *
 */
- (void) setUser: (MSOneNoteOneNoteUser *) value {
    _user = value;
