...
#ifndef MSONENOTECOPYSTATUSMODEL_H
#define MSONENOTECOPYSTATUSMODEL_H
...
/** Interface MSOneNoteCopyStatusModel
 *
 */
@interface MSOneNoteCopyStatusModel : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>
