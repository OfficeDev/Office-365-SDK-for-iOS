...
#ifndef MSONENOTEIMPORTSTATUSMODEL_H
#define MSONENOTEIMPORTSTATUSMODEL_H
...
/** Interface MSOneNoteImportStatusModel
 *
 */
@interface MSOneNoteImportStatusModel : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>
