...
@property (retain, nonatomic, readwrite, getter=registeredOwners, setter=setRegisteredOwners:) NSMutableArray<MSGraphDirectoryObject> *registeredOwners;
@property (retain, nonatomic, readwrite, getter=registeredUsers, setter=setRegisteredUsers:) NSMutableArray<MSGraphDirectoryObject> *registeredUsers;
