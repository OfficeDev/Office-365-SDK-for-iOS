...
- (MSDiscoveryServiceInfoFetcher *)getById:(NSString *)_id {

    return [[MSDiscoveryServiceInfoFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,_id] parent:self];
}
