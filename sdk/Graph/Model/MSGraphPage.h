...
#ifndef MSGRAPHPAGE_H
#define MSGRAPHPAGE_H
 ...
 *
 */
@interface MSGraphPage : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>
 ...
 *
 */
@property (nonatomic,  copy, setter=setParentSection:, getter=parentSection) MSGraphSection * parentSection;

/** Property parentNotebook
 *
 */
@property (nonatomic,  copy, setter=setParentNotebook:, getter=parentNotebook) MSGraphNotebook * parentNotebook;
