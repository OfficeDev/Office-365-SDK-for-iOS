...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
		...
		_appRoleAssignedTo = (![dic objectForKey: @"appRoleAssignedTo"] || [ [dic objectForKey: @"appRoleAssignedTo"] isKindOfClass:[NSNull class]] )?_appRoleAssignedTo:[[MSGraphAppRoleAssignment alloc] initWithDictionary: [dic objectForKey: @"appRoleAssignedTo"]];
