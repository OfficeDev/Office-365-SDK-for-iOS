...
/** Implementation for MSGraphDriveItem
 *
 */
    ...
    if((self = [self init])) {
        ...
        if([dic objectForKey: @"versions"] != [NSNull null]){
            ...
            for (id object in [dic objectForKey: @"versions"]) {
                [_versions addObject:[[MSGraphDriveItem alloc] initWithDictionary: object]];
            }
        ...
        if([dic objectForKey: @"children"] != [NSNull null]){
            ...
            for (id object in [dic objectForKey: @"children"]) {
                [_children addObject:[[MSGraphDriveItem alloc] initWithDictionary: object]];
            }
