...
#ifndef MSGRAPHTASKBOARDTASKFORMAT_H
#define MSGRAPHTASKBOARDTASKFORMAT_H
 ...
 *
 */
@interface MSGraphTaskBoardTaskFormat : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>
