...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
        if(dic!=nil) {
		_action = (![dic objectForKey: @"action"] || [ [dic objectForKey: @"action"] isKindOfClass:[NSNull class]] )?_action:[MSGraphPatchActionTypeSerializer fromString:[dic objectForKey: @"action"]];
		...
		_position = (![dic objectForKey: @"position"] || [ [dic objectForKey: @"position"] isKindOfClass:[NSNull class]] )?_position:[MSGraphPatchInsertPositionSerializer fromString:[dic objectForKey: @"position"]];
    }
