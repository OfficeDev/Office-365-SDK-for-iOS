...
#ifndef MSGRAPHOUTLOOKGEOCOORDINATES_H
#define MSGRAPHOUTLOOKGEOCOORDINATES_H
 ...
 *
 */
@interface MSGraphOutlookGeoCoordinates : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>
