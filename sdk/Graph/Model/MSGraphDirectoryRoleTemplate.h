...
#ifndef MSGRAPHDIRECTORYROLETEMPLATE_H
#define MSGRAPHDIRECTORYROLETEMPLATE_H
 ...
 *
 */
@interface MSGraphDirectoryRoleTemplate : MSGraphDirectoryObject <MSOrcInteroperableWithDictionary>
