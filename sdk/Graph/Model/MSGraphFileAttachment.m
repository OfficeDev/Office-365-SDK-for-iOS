...
+ (NSDictionary *) $$$_$$$propertiesNamesMappings
{
    ...
    _$$$_$$$propertiesNamesMappings=[[NSDictionary alloc] initWithObjectsAndKeys:  @"ContentId", @"contentId", @"ContentLocation", @"contentLocation", @"IsContactPhoto", @"isContactPhoto", @"ContentBytes", @"contentBytes", @"Id", @"_id", @"Name", @"name", @"ContentType", @"contentType", @"Size", @"size", @"IsInline", @"isInline", @"DateTimeLastModified", @"dateTimeLastModified", nil];
