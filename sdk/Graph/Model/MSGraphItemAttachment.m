...
+ (NSDictionary *) $$$_$$$propertiesNamesMappings
{
    ...
    _$$$_$$$propertiesNamesMappings=[[NSDictionary alloc] initWithObjectsAndKeys:  @"Item", @"item", @"Id", @"_id", @"Name", @"name", @"ContentType", @"contentType", @"Size", @"size", @"IsInline", @"isInline", @"DateTimeLastModified", @"dateTimeLastModified", nil];
