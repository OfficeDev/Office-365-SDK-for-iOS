...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_odataType = @"#microsoft.graph.Notes";
    ...
    if((self = [self init])) {
        ...
        if([dic objectForKey: @"notebooks"] != [NSNull null]){
            ...
            for (id object in [dic objectForKey: @"notebooks"]) {
                [_notebooks addObject:[[MSGraphNotebook alloc] initWithDictionary: object]];
            }
        ...
        if([dic objectForKey: @"resources"] != [NSNull null]){
            ...
            for (id object in [dic objectForKey: @"resources"]) {
                [_resources addObject:[[MSGraphResource alloc] initWithDictionary: object]];
            }
