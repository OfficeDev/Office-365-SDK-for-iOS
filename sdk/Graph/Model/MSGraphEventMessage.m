...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
        ...
        if([dic objectForKey: @"Extensions"] != [NSNull null]){
            self.extensions = [NSMutableArray arrayWithCapacity:[[dic objectForKey: @"Extensions"] count]];
...
- (NSDictionary *) toDictionary {
	...
	{id curVal = [MSGraphMeetingMessageTypeSerializer toString:self.meetingMessageType]; if (curVal!=nil) [dic setValue: curVal forKey: @"MeetingMessageType"];}
	...
	{id curVal = [MSGraphInferenceClassificationTypeSerializer toString:self.inferenceClassification]; if (curVal!=nil) [dic setValue: curVal forKey: @"InferenceClassification"];}
...
- (NSDictionary *) toUpdatedValuesDictionary {
    ...
    {
        [dic setValue: curVal==nil?[NSNull null]:[MSGraphMeetingMessageTypeSerializer toString:curVal] forKey: @"MeetingMessageType"];
    }
        else
    {
    ...
    {
        [dic setValue: curVal==nil?[NSNull null]:[MSGraphInferenceClassificationTypeSerializer toString:curVal] forKey: @"InferenceClassification"];
    }
        else
    {
