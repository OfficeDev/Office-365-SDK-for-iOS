...
/** Implementation for MSGraphCopyPageModel
 *
 */
@implementation MSGraphCopyPageModel
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_odataType = @"#microsoft.graph.CopyPageModel";
...
- (NSDictionary *) toDictionary {
    ...
    [dic setValue: @"#microsoft.graph.CopyPageModel" forKey: @"@odata.type"];
 ...
 *
 */
- (void) setParentSection: (MSGraphCopySectionModel *) value {
 ...
 *
 */
- (void) setParentNotebook: (MSGraphCopyNotebookModel *) value {
