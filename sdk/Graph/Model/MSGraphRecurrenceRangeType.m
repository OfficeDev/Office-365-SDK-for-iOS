...
@implementation MSGraphRecurrenceRangeTypeSerializer
...
+(NSString *) toString: (MSGraphRecurrenceRangeType) value {
    ...
    {
        stringMappings=[[NSDictionary alloc] initWithObjectsAndKeys:
         @"EndDate", [NSNumber numberWithInt:MSGraphRecurrenceRangeTypeEndDate], @"NoEnd", [NSNumber numberWithInt:MSGraphRecurrenceRangeTypeNoEnd], @"Numbered", [NSNumber numberWithInt:MSGraphRecurrenceRangeTypeNumbered],
            nil        
        ];
    }
