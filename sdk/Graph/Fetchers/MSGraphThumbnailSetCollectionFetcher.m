...
@implementation MSGraphThumbnailSetCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphThumbnailSet class]];
}

- (void)add:(MSGraphThumbnailSet*)entity callback:(void (^)(MSGraphThumbnailSet *mSGraphThumbnailSet, MSOrcError *error))callback {
...
- (MSGraphThumbnailSetFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphThumbnailSetFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
