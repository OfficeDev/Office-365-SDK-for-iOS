...
- (MSGraphReferenceAttachmentFetcher *)getById:(NSString *)_id {

    return [[MSGraphReferenceAttachmentFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,_id] parent:self];
}
