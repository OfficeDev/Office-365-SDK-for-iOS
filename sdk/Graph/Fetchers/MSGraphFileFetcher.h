...
#ifndef MSGRAPHFILEFETCHER_H
#define MSGRAPHFILEFETCHER_H

#import <orc.h>
#import "MSGraphModels.h"
#import "MSOrcMediaEntityFetcher.h"

@class MSGraphImageFacetFetcher;
 ...
 *
 */
@interface MSGraphFileFetcher : MSOrcMediaEntityFetcher

@property (copy, nonatomic, readonly) MSGraphFileOperations *operations;

- (instancetype)initWithUrl:(NSString*)urlComponent parent:(id<MSOrcExecutable>)parent;
- (void)readWithCallback:(void (^)(MSGraphFile *, MSOrcError *))callback;
- (void)update:(MSGraphFile *)File callback:(void (^)(MSGraphFile *, MSOrcError*))callback ;
