...
- (MSGraphDirectoryObjectFetcher *)registeredOwnersById:(NSString *)identifier {
    ...
    return [[[MSGraphDirectoryObjectCollectionFetcher alloc] initWithUrl:@"registeredOwners" parent:self asClass:[MSGraphDirectoryObject class]] getById:identifier];
...
- (MSGraphDirectoryObjectFetcher *)registeredUsersById:(NSString *)identifier {
    ...
    return [[[MSGraphDirectoryObjectCollectionFetcher alloc] initWithUrl:@"registeredUsers" parent:self asClass:[MSGraphDirectoryObject class]] getById:identifier];
