...
#ifndef MSGRAPHMAILFOLDEROPERATIONS_H
#define MSGRAPHMAILFOLDEROPERATIONS_H
...
/** MSGraphMailFolderOperations
 *
 */
@interface MSGraphMailFolderOperations : MSGraphEntityOperations
