...
#ifndef MSGRAPHPROFILEPHOTOCOLLECTIONFETCHER_H
#define MSGRAPHPROFILEPHOTOCOLLECTIONFETCHER_H
...
/** MSGraphProfilePhotoCollectionFetcher
 *
 */
@interface MSGraphProfilePhotoCollectionFetcher : MSOrcCollectionFetcher
...
- (void)add:(MSGraphProfilePhoto *)entity callback:(void (^)(MSGraphProfilePhoto *, MSOrcError *))callback;
