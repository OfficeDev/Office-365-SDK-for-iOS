...
- (MSGraphExtensionPropertyFetcher *)getById:(NSString *)_id {

    return [[MSGraphExtensionPropertyFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,_id] parent:self];
}
