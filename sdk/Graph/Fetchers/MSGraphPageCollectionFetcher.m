...
@implementation MSGraphPageCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphPage class]];
}

- (void)add:(MSGraphPage*)entity callback:(void (^)(MSGraphPage *mSGraphPage, MSOrcError *error))callback {
...
- (MSGraphPageFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphPageFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
