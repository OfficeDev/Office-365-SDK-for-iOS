...
#ifndef MSGRAPHDEVICECONFIGURATIONFETCHER_H
#define MSGRAPHDEVICECONFIGURATIONFETCHER_H
...
/** MSGraphDeviceConfigurationFetcher
 *
 */
...
- (void)readWithCallback:(void (^)(MSGraphDeviceConfiguration *, MSOrcError *))callback;
- (void)update:(MSGraphDeviceConfiguration *)DeviceConfiguration callback:(void (^)(MSGraphDeviceConfiguration *, MSOrcError*))callback ;
