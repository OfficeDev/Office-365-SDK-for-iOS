...
- (MSGraphDirectoryObjectFetcher *)getById:(NSString *)_id {

    return [[MSGraphDirectoryObjectFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,_id] parent:self];
}
