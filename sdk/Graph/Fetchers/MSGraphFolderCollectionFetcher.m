...
- (void)add:(MSGraphFolder*)entity callback:(void (^)(MSGraphFolder *mSGraphFolder, MSOrcError *error))callback {
...
- (MSGraphFolderFetcher *)getById:(NSString *)_id {

    return [[MSGraphFolderFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,_id] parent:self];
}
