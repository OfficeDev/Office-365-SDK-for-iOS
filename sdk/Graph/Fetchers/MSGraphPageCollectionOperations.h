...
#ifndef MSGRAPHPAGECOLLECTIONOPERATIONS_H
#define MSGRAPHPAGECOLLECTIONOPERATIONS_H
...
/** MSGraphPageCollectionOperations
 *
 */
@interface MSGraphPageCollectionOperations : MSOrcOperations
