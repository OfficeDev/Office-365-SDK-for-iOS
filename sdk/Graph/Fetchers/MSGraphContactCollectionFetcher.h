...
#ifndef MSGRAPHCONTACTCOLLECTIONFETCHER_H
#define MSGRAPHCONTACTCOLLECTIONFETCHER_H
...
/** MSGraphContactCollectionFetcher
 *
 */
...
- (void)add:(MSGraphContact *)entity callback:(void (^)(MSGraphContact *, MSOrcError *))callback;
