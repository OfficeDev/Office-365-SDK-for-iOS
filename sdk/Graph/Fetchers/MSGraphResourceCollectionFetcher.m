...
@implementation MSGraphResourceCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphResource class]];
}

- (void)add:(MSGraphResource*)entity callback:(void (^)(MSGraphResource *mSGraphResource, MSOrcError *error))callback {
...
- (MSGraphResourceFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphResourceFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
