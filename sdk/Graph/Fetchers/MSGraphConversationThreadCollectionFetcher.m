...
- (MSGraphConversationThreadFetcher *)getById:(NSString *)_id {

    return [[MSGraphConversationThreadFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,_id] parent:self];
}
