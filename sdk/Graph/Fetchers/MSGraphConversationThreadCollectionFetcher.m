...
@implementation MSGraphConversationThreadCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphConversationThread class]];
}

- (void)add:(MSGraphConversationThread*)entity callback:(void (^)(MSGraphConversationThread *mSGraphConversationThread, MSOrcError *error))callback {
...
- (MSGraphConversationThreadFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphConversationThreadFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
