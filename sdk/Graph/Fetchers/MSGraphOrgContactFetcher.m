...
@implementation MSGraphOrgContactFetcher

@synthesize operations = _operations;

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSGraphOrgContact class]]) {

		_operations = [[MSGraphOrgContactOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSGraphOrgContact *OrgContact, MSOrcError *e))callback {
...
- (void) readWithCallback:(void (^)(MSGraphOrgContact *OrgContact, MSOrcError *error))callback {
