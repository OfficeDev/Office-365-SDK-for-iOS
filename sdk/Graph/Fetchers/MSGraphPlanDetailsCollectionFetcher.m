...
@implementation MSGraphPlanDetailsCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphPlanDetails class]];
}

- (void)add:(MSGraphPlanDetails*)entity callback:(void (^)(MSGraphPlanDetails *mSGraphPlanDetails, MSOrcError *error))callback {
...
- (MSGraphPlanDetailsFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphPlanDetailsFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
