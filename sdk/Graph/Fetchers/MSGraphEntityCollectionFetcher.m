...
@implementation MSGraphEntityCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphEntity class]];
}

- (void)add:(MSGraphEntity*)entity callback:(void (^)(MSGraphEntity *mSGraphEntity, MSOrcError *error))callback {
...
- (MSGraphEntityFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphEntityFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
