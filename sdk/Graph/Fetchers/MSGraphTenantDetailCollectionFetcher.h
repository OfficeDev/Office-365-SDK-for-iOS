...
#ifndef MSGRAPHTENANTDETAILCOLLECTIONFETCHER_H
#define MSGRAPHTENANTDETAILCOLLECTIONFETCHER_H
...
/** MSGraphTenantDetailCollectionFetcher
 *
 */
...
- (void)add:(MSGraphTenantDetail *)entity callback:(void (^)(MSGraphTenantDetail *, MSOrcError *))callback;
