...
#ifndef MSGRAPHDRIVEITEMOPERATIONS_H
#define MSGRAPHDRIVEITEMOPERATIONS_H
...
/** MSGraphDriveItemOperations
 *
 */
@interface MSGraphDriveItemOperations : MSGraphEntityOperations
