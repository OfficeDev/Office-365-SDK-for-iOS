...
@implementation MSGraphSectionCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphSection class]];
}

- (void)add:(MSGraphSection*)entity callback:(void (^)(MSGraphSection *mSGraphSection, MSOrcError *error))callback {
...
- (MSGraphSectionFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphSectionFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
