...
@implementation MSGraphOrgContactCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphOrgContact class]];
}

- (void)add:(MSGraphOrgContact*)entity callback:(void (^)(MSGraphOrgContact *mSGraphOrgContact, MSOrcError *error))callback {
...
- (MSGraphOrgContactFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphOrgContactFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
