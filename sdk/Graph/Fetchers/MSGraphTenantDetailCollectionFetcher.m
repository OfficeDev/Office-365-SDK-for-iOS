...
- (MSGraphTenantDetailFetcher *)getById:(id) identifier {

    return [[MSGraphTenantDetailFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
