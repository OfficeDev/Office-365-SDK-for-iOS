...
- (MSGraphOAuth2PermissionGrantFetcher *)getById:(NSString *)_id {

    return [[MSGraphOAuth2PermissionGrantFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,_id] parent:self];
}
