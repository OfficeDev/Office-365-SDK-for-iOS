...
@implementation MSGraphPrivilegedSecurityAlertCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphPrivilegedSecurityAlert class]];
}

- (void)add:(MSGraphPrivilegedSecurityAlert*)entity callback:(void (^)(MSGraphPrivilegedSecurityAlert *mSGraphPrivilegedSecurityAlert, MSOrcError *error))callback {
...
- (MSGraphPrivilegedSecurityAlertFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphPrivilegedSecurityAlertFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
