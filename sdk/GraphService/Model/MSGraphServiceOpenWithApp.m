...
/** Implementation for MSGraphServiceOpenWithApp
 *
 */
@implementation MSGraphServiceOpenWithApp
...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
        if(dic!=nil) {
		_app = (![dic objectForKey: @"app"] || [ [dic objectForKey: @"app"] isKindOfClass:[NSNull class]] )?_app:[[MSGraphServiceIdentity alloc] initWithDictionary: [dic objectForKey: @"app"]];
 ...
 *
 */
- (void) setApp: (MSGraphServiceIdentity *) value {
    _app = value;
