...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
		...
		_accessType = (![dic objectForKey: @"AccessType"] || [ [dic objectForKey: @"AccessType"] isKindOfClass:[NSNull class]] )?_accessType:[MSGraphServiceGroupAccessTypeSerializer fromString:[dic objectForKey: @"AccessType"]];
...
if (curVal!=nil) [dic setValue: curVal forKey: @"proxyAddresses"];}
	...
	{[dic setValue: [MSGraphServiceGroupAccessTypeSerializer toString:self.accessType] forKey: @"AccessType"];}
 ...
 *
 */
- (void) setAccessType: (MSGraphServiceGroupAccessType) value {
    _accessType = value;
...
- (void)setAccessTypeString:(NSString *)string {
    ...
    _accessType = [MSGraphServiceGroupAccessTypeSerializer fromString:string];
    [self valueChangedFor:@"AccessType"]; 
}
