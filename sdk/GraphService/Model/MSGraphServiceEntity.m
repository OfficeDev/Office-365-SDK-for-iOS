...
/** Implementation for MSGraphServiceEntity
 *
 */
@implementation MSGraphServiceEntity
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_odataType = @"#microsoft.graph.entity";
...
- (NSDictionary *) toDictionary {
    ...
    [dic setValue: @"#microsoft.graph.entity" forKey: @"@odata.type"];
