...
/** Implementation for MSGraphServiceOpenWithSet
 *
 */
@implementation MSGraphServiceOpenWithSet
...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
        if(dic!=nil) {
		_web = (![dic objectForKey: @"web"] || [ [dic objectForKey: @"web"] isKindOfClass:[NSNull class]] )?_web:[[MSGraphServiceOpenWithApp alloc] initWithDictionary: [dic objectForKey: @"web"]];
		_webEmbedded = (![dic objectForKey: @"webEmbedded"] || [ [dic objectForKey: @"webEmbedded"] isKindOfClass:[NSNull class]] )?_webEmbedded:[[MSGraphServiceOpenWithApp alloc] initWithDictionary: [dic objectForKey: @"webEmbedded"]];
    }
 ...
 *
 */
- (void) setWeb: (MSGraphServiceOpenWithApp *) value {
    _web = value;
 ...
 *
 */
- (void) setWebEmbedded: (MSGraphServiceOpenWithApp *) value {
    _webEmbedded = value;
