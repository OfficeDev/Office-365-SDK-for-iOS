...
@implementation MSGraphServiceBodyTypeSerializer
...
+(MSGraphServiceBodyType) fromString:(NSString *) string {
    ...
    if(stringMappings==nil)
    {
        stringMappings=[[NSDictionary alloc] initWithObjectsAndKeys:
         [NSNumber numberWithInt:MSGraphServiceBodyTypeText], @"Text", [NSNumber numberWithInt:MSGraphServiceBodyTypeHTML], @"HTML",
            nil        
        ];
    }
...
+(NSString *) toString: (MSGraphServiceBodyType) value {
    ...
    {
        stringMappings=[[NSDictionary alloc] initWithObjectsAndKeys:
         @"Text", [NSNumber numberWithInt:MSGraphServiceBodyTypeText], @"HTML", [NSNumber numberWithInt:MSGraphServiceBodyTypeHTML],
            nil        
        ];
    }
