...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
		...
		_openWith = (![dic objectForKey: @"openWith"] || [ [dic objectForKey: @"openWith"] isKindOfClass:[NSNull class]] )?_openWith:[[MSGraphServiceOpenWithSet alloc] initWithDictionary: [dic objectForKey: @"openWith"]];
        ...
        if([dic objectForKey: @"versions"] != [NSNull null]){
            ...
            for (id object in [dic objectForKey: @"versions"]) {
                [_versions addObject:[[MSGraphServiceDriveItem alloc] initWithDictionary: object]];
            }
 ...
 *
 */
- (void) setOpenWith: (MSGraphServiceOpenWithSet *) value {
    _openWith = value;
