...
@property (strong, nonatomic, readonly, getter=joinedGroups) MSGraphServiceGroupCollectionFetcher *joinedGroups;

- (MSGraphServiceGroupFetcher *)joinedGroupsById:(id)identifier;
