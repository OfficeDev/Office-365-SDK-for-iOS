...
- (MSGraphServiceDriveItemCollectionFetcher *)shared {

    return [[MSGraphServiceDriveItemCollectionFetcher alloc] initWithUrl:@"shared" parent:self asClass:[MSGraphServiceDriveItem class]];
}

- (MSGraphServiceDriveItemFetcher *)sharedById:(NSString *)identifier {

    return [[[MSGraphServiceDriveItemCollectionFetcher alloc] initWithUrl:@"shared" parent:self asClass:[MSGraphServiceDriveItem class]] getById:identifier];
