...
@implementation MSGraphServiceThumbnailSetCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphServiceThumbnailSet class]];
}

- (void)add:(MSGraphServiceThumbnailSet*)entity callback:(void (^)(MSGraphServiceThumbnailSet *mSGraphServiceThumbnailSet, MSOrcError *error))callback {
...
- (MSGraphServiceThumbnailSetFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphServiceThumbnailSetFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
