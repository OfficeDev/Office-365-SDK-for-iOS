...
@implementation MSGraphServicePermissionCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphServicePermission class]];
}

- (void)add:(MSGraphServicePermission*)entity callback:(void (^)(MSGraphServicePermission *mSGraphServicePermission, MSOrcError *error))callback {
...
- (MSGraphServicePermissionFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphServicePermissionFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
