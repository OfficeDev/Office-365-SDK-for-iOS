...
- (void)add:(MSGraphServiceDevice*)entity callback:(void (^)(MSGraphServiceDevice *mSGraphServiceDevice, MSOrcError *error))callback {
...
- (MSGraphServiceDeviceFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphServiceDeviceFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
