...
@implementation MSGraphServicePostCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphServicePost class]];
}

- (void)add:(MSGraphServicePost*)entity callback:(void (^)(MSGraphServicePost *mSGraphServicePost, MSOrcError *error))callback {
...
- (MSGraphServicePostFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphServicePostFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
