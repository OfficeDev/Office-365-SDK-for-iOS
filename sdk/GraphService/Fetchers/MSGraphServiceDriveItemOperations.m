...
/** Implementation for MSGraphServiceDriveItemOperations
 *
 */
@implementation MSGraphServiceDriveItemOperations
...
- (void)inviteRawWithRecipients:(NSString *)recipients message:(NSString *)message requireSignIn:(NSString *)requireSignIn sendInvitation:(NSString *)sendInvitation roles:(NSString *)roles callback:(void (^)(NSString *, MSOrcError*))callback {
    ...
    [request setVerb:HTTP_VERB_POST];
	 	[request.url appendPathComponent:@"microsoft.graph.invite"];
...
- (void)copyWithParentReference:(MSGraphServiceItemReference *)parentReference name:(NSString *)name callback:(void (^)(MSGraphServiceDriveItem *, MSOrcError*))callback {
  ...
  NSString *nameString = [NSString stringWithFormat:@"\"%@\"", name];
    ...
    return [self copyRawWithParentReference:parentReferenceString name:nameString callback:^(NSString *returnValue, MSOrcError *e) {
       ...
       if (e == nil) {
            MSGraphServiceDriveItem * result = (MSGraphServiceDriveItem *)[MSOrcObjectizer objectizeFromString:returnValue toType: [MSGraphServiceDriveItem  class]];
            callback(result, e);
        } 
        else {
...
- (void)createSessionWithItem:(MSGraphServiceChunkedUploadSessionDescriptor *)item callback:(void (^)(MSGraphServiceUploadSession *, MSOrcError*))callback {
    ...
    return [self createSessionRawWithItem:itemString callback:^(NSString *returnValue, MSOrcError *e) {
       ...
       if (e == nil) {
            MSGraphServiceUploadSession * result = (MSGraphServiceUploadSession *)[MSOrcObjectizer objectizeFromString:returnValue toType: [MSGraphServiceUploadSession  class]];
            callback(result, e);
        } 
        else {
...
- (void)createSessionRawWithItem:(NSString *)item callback:(void (^)(NSString *, MSOrcError*))callback {
    ...
    [request setVerb:HTTP_VERB_POST];
	 	[request.url appendPathComponent:@"microsoft.graph.createSession"];
