...
@implementation MSGraphServiceEntityCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphServiceEntity class]];
}

- (void)add:(MSGraphServiceEntity*)entity callback:(void (^)(MSGraphServiceEntity *mSGraphServiceEntity, MSOrcError *error))callback {
...
- (MSGraphServiceEntityFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphServiceEntityFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
