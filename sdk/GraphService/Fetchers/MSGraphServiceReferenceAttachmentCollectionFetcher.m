...
- (void)add:(MSGraphServiceReferenceAttachment*)entity callback:(void (^)(MSGraphServiceReferenceAttachment *mSGraphServiceReferenceAttachment, MSOrcError *error))callback {
...
- (MSGraphServiceReferenceAttachmentFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphServiceReferenceAttachmentFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
