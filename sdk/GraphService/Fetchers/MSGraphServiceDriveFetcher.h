...
@property (strong, nonatomic, readonly, getter=shared) MSGraphServiceDriveItemCollectionFetcher *shared;

- (MSGraphServiceDriveItemFetcher *)sharedById:(id)identifier;
