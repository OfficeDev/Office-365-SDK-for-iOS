...
@implementation MSGraphServiceConversationThreadCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphServiceConversationThread class]];
}

- (void)add:(MSGraphServiceConversationThread*)entity callback:(void (^)(MSGraphServiceConversationThread *mSGraphServiceConversationThread, MSOrcError *error))callback {
...
- (MSGraphServiceConversationThreadFetcher *)getById:(id) identifier {
    ...
    return [[MSGraphServiceConversationThreadFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
