...
- (MSDirectoryServicesDeviceFetcher *)getById:(NSString *)_id {

    return [[MSDirectoryServicesDeviceFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,_id] parent:self];
}
