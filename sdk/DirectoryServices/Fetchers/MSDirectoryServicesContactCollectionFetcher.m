...
- (MSDirectoryServicesContactFetcher *)getById:(NSString *)_id {

    return [[MSDirectoryServicesContactFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,_id] parent:self];
}
