...
- (MSDirectoryServicesAppRoleAssignmentFetcher *)getById:(NSString *)_id {

    return [[MSDirectoryServicesAppRoleAssignmentFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,_id] parent:self];
}
