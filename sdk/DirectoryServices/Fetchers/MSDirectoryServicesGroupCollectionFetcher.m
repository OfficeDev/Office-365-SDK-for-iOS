...
- (MSDirectoryServicesGroupFetcher *)getById:(NSString *)_id {

    return [[MSDirectoryServicesGroupFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,_id] parent:self];
}
