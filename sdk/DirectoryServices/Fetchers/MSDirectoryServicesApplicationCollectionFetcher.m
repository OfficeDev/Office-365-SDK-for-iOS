...
- (MSDirectoryServicesApplicationFetcher *)getById:(NSString *)_id {

    return [[MSDirectoryServicesApplicationFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,_id] parent:self];
}
