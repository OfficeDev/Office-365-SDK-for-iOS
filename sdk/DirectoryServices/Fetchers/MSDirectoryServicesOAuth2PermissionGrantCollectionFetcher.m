...
- (MSDirectoryServicesOAuth2PermissionGrantFetcher *)getById:(NSString *)_id {

    return [[MSDirectoryServicesOAuth2PermissionGrantFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,_id] parent:self];
}
