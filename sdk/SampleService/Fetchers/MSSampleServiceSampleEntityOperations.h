...
#ifndef MSSAMPLESERVICESAMPLEENTITYOPERATIONS_H
#define MSSAMPLESERVICESAMPLEENTITYOPERATIONS_H
...
/** MSSampleServiceSampleEntityOperations
 *
 */
@interface MSSampleServiceSampleEntityOperations : MSSampleServiceEntityOperations
