...
#ifndef MSSAMPLESERVICEANOTHERENTITYCOLLECTIONFETCHER_H
#define MSSAMPLESERVICEANOTHERENTITYCOLLECTIONFETCHER_H
...
/** MSSampleServiceAnotherEntityCollectionFetcher
 *
 */
@interface MSSampleServiceAnotherEntityCollectionFetcher : MSOrcCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent;

- (MSSampleServiceAnotherEntityFetcher *)getById: (id) identifier;
- (void)add:(MSSampleServiceAnotherEntity *)entity callback:(void (^)(MSSampleServiceAnotherEntity *, MSOrcError *))callback;
