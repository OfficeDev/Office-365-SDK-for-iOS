...
- (MSOutlookDirectoryObjectFetcher *)getById:(NSString *)_id {

    return [[MSOutlookDirectoryObjectFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,_id] parent:self];
}
